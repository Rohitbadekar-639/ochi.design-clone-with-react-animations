    ...
    <div className="w-full h-screen flex bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold uppercase leading-none tracking-tighter -mb-5">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase leading-none tracking-tighter -mb-5">
            Opening
      ...
      <div className="w-1/2 flex flex-col justify-between">
        ...
        <div className="flex justify-between w-full">
          <div className="details mt-50 w-1/4">
            <h1 className="font-bold mb-2">S:</h1>
          ...
          <div className="details mt-50 w-1/4">
            <a className="block" href="#">
              <h1 className="font-bold mb-2">L:</h1>
              202-1965 W 4th Ave Vancouver, Canada
            </a>
          </div>
          <div className="details mt-50 w-[1vw]">
            <a className="block" href="#">
              <div className="font-bold mb-2">E:</div>
              rohitbadekar555@gmail.com
            </a>
          </div>
          <div className="details mt-50 w-1/4 mt-32">
            <h1 className="font-bold mb-2">M:</h1>
            <a className="block underline" href="#">
              Home
            </a>
            <a className="block underline" href="#">
        ...
        <p>&copy; Rohit Badekar Designs 2025. All Rights Reserved!</p>
      </div>
    </div>
  );
}
